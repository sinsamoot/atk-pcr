            ...
            <div class="col-md-6 d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page" style="color: green"><h5>รายการกิจกรรม</h5></li>
                    </ol>
                </nav>                                
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{route('activity.show',$res->a_id)}}" type="button" class="btn btn-primary">
